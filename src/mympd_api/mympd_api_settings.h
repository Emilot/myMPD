...
bool mympd_api_settings_set(t_config *config, t_mympd_state *mympd_state, struct json_token *key, struct json_token *val,
                            bool *mpd_conf_changed, bool *ns_changed, bool *apmode_changed, bool *airplay_changed, bool *dac_changed, bool *roon_changed, bool *spotify_changed, bool *ffmpeg_changed);
