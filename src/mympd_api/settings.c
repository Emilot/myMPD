...
void mympd_api_settings_statefiles_global_read(struct t_mympd_state *mympd_state) {
    ...
    mympd_state->wifi = state_file_rw_bool(workdir, DIR_WORK_STATE, "wifi", mympd_state->wifi, true);
    mympd_state->dop = state_file_rw_bool(workdir, DIR_WORK_STATE, "dop", mympd_state->dop, true);
    mympd_state->ffmpeg = state_file_rw_bool(workdir, DIR_WORK_STATE, "ffmpeg", mympd_state->ffmpeg, true);
    mympd_state->apmode = state_file_rw_bool(workdir, DIR_WORK_STATE, "apmode", mympd_state->apmode, true);
    ...
    mympd_state->wifissid = state_file_rw_string_sds(workdir, DIR_WORK_STATE, "wifissid", mympd_state->wifissid, vcb_isname, true);
    mympd_state->wifi_password = state_file_rw_string_sds(workdir, DIR_WORK_STATE, "wifi_password", mympd_state->wifi_password, vcb_isname, true);
