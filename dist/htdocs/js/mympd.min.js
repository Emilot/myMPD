...
showNotification(t(c.params.message),"","","danger");break;case "warn":document.getElementById("alertMpdState").classList.contains("hide")&&showNotification(t(c.params.message),"","","warning");break;case "info":document.getElementById("alertMpdState").classList.contains("hide")&&showNotification(t(c.params.message),"","","success")}},socket.onclose=function(){logError("Websocket is disconnected");websocketConnected=!1;!0===appInited?(toggleUI(),progressTimer&&clearTimeout(progressTimer)):(showAppInitAlert(t("Websocket connection failed")),
...
!0:!1,ffmpeg:document.getElementById("btnFFmpeg").classList.contains("active")?!0:!1,nsType:parseInt(b),nsServer:c.value,nsShare:d.value,sambaVersion:m.options[m.selectedIndex].value,nsUsername:f.value,nsPassword:g.value,airplay:document.getElementById("btnAirplay").classList.contains("active")?!0:!1,roon:document.getElementById("btnRoon").classList.contains("active")?!0:!1,spotify:document.getElementById("btnSpotify").classList.contains("active")?!0:!1,tidalEnabled:document.getElementById("btnTidalEnabled").classList.contains("active")?
!0:!1,tidalUsername:h.value,tidalPassword:k.value,tidalAudioquality:n.options[n.selectedIndex].value},getSettings);modalCollybia.hide()}}
...
var socket=null,lastSong="",lastSongObj={},lastState,currentSong={},playstate="",settingsLock=!1,settingsParsed=!1,settingsNew={},settings={loglevel:2},alertTimeout=null,progressTimer=null,deferredPrompt,dragEl,websocketConnected=!1,websocketTimer=null,appInited=!1,subdir="",uiEnabled=!0,locale=navigator.language||navigator.userLanguage,scale="1.0",isMobile=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent),ligatureMore="menu",app={apps:{Playback:{state:"0/AlbumArtist/AlbumArtist/",scrollPos:0},
...
dragAndDropTableHeader("QueueCurrent");dragAndDropTableHeader("QueueLastPlayed");dragAndDropTableHeader("Search");dragAndDropTableHeader("BrowseFilesystem");dragAndDropTableHeader("BrowsePlaylistsDetail");window.addEventListener("hashchange",appRoute,!1);window.addEventListener("focus",function(){sendAPI("MPD_API_PLAYER_STATE",{},parseState)},!1);document.addEventListener("keydown",function(a){if("INPUT"!==a.target.tagName&&"SELECT"!==a.target.tagName&&"TEXTAREA"!==a.target.tagName&&!a.ctrlKey&&!a.altKey){var b=
keymap[a.key];b&&"function"===typeof window[b.cmd]&&(void 0===keymap[a.key].req||!0===settings[keymap[a.key].req])&&parseCmd(a,b)}},!1);a=document.getElementsByTagName("table");for(b=0;b<a.length;b++)a[b].setAttribute("tabindex",0),a[b].addEventListener("keydown",function(a){navigateTable(this,a.key)},!1);var d="";Object.keys(themes).forEach(function(a){d+='<option value="'+e(a)+'">'+t(themes[a])+"</option>"});document.getElementById("selectTheme").innerHTML=d;window.addEventListener("beforeinstallprompt",
...
function(){logError("localPlayer event: error");document.getElementById("errorLocalPlayback").classList.remove("hide")});updateDBstats();checkForUpdates()}window.onerror=function(a,b,c){logError("JavaScript error: "+a+" ("+b+": "+c+")");4<=settings.loglevel&&(!0===appInited?showNotification(t("JavaScript error"),a+" ("+b+": "+c+")","","danger"):showAppInitAlert(t("JavaScript error")+": "+a+" ("+b+": "+c+")"));return!0};appInitStart();
