...
function parseCollybiaSettings(){document.getElementById("selectDac").value=settings.dac;document.getElementById("selectMixerType").value=settings.mixerType;toggleBtnChk("btnDop",settings.dop);document.getElementById("selectNsType").value=settings.nsType;document.getElementById("inputNsServer").value=settings.nsServer;document.getElementById("inputNsShare").value=settings.nsShare;document.getElementById("selectSambaVersion").value=settings.sambaVersion;document.getElementById("inputNsUsername").value=
...
!0:!1,nsType:parseInt(b),nsServer:c.value,nsShare:d.value,sambaVersion:m.options[m.selectedIndex].value,nsUsername:f.value,nsPassword:g.value,airplay:document.getElementById("btnAirplay").classList.contains("active")?!0:!1,roon:document.getElementById("btnRoon").classList.contains("active")?!0:!1,spotify:document.getElementById("btnSpotify").classList.contains("active")?!0:!1,tidalEnabled:document.getElementById("btnTidalEnabled").classList.contains("active")?!0:!1,tidalUsername:h.value,tidalPassword:k.value,
tidalAudioquality:n.options[n.selectedIndex].value},getSettings);modalCollybia.hide()}}
